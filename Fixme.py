...
def evens(n):
    ...
    []
    '''
    list(filter(lambda n: n%2 == 0, range(0,n))
...
def threes(n):
    ...
    '''
    list(filter(lamda n: 3 in n, range(0,n))
...
def small_words(text):
    ...
    ['a', 'big', 'word', 'is', 'bad']
    '''
    list(filter(lambda text: len(text) < 5, range(0,len(text))
...
def squares(n):
    ...
    '''
    list(filter(lambda n: n * n, range(0,n))
